...
const css = `
  ...
  .hp-carousel-text {
    font-size: 14px; color: var(--color-primary-dark); font-weight: 500;
  ...
  .hp-dot.hp-dot-active { background: var(--color-primary); width: 18px; border-radius: 3px; }
  ...
  .hp-eyebrow {
    ...
    background: var(--color-primary-light); border: 1px solid rgba(29,158,117,0.22);
  ...
  .hp-headline {
    ...
    color: var(--color-text-primary); margin: 0 0 20px; letter-spacing: -0.025em;
  }
  .hp-sub {
    font-size: 18px; color: var(--color-text-secondary); line-height: 1.67;
  ...
  .hp-btn-primary:hover { background: var(--color-primary-dark); transform: translateY(-1px); }
  .hp-btn-secondary {
    padding: 14px 28px; background: var(--color-surface-raised); color: var(--color-primary);
    border: 1.5px solid var(--color-primary); border-radius: 10px;
    font-size: 15px; font-weight: 600; font-family: var(--font-body);
    cursor: pointer; transition: all 0.15s;
  }
  .hp-btn-secondary:hover { background: var(--color-primary-light); }
  ...
  .hp-data-item {
    padding: 8px 32px; font-size: 14px; color: var(--color-text-secondary);
    font-weight: 500; text-align: center;
  }
  .hp-data-sep { width: 1px; height: 20px; background: var(--color-border); flex-shrink: 0; }
  ...
  .hp-feat-headline {
    ...
    color: var(--color-text-primary); margin: 0 0 16px; letter-spacing: -0.015em;
  }
  .hp-feat-body {
    font-size: 16px; color: var(--color-text-secondary); line-height: 1.72; margin: 0 0 28px;
  }

  /* Plan visual */
  .hp-plan-visual {
    background: var(--color-primary-light); border: 1px solid rgba(29,158,117,0.15);
    border-radius: 20px; padding: 28px;
    display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;
    box-shadow: 0 6px 32px rgba(29,158,117,0.1);
  }
  .hp-mini-card {
    background: var(--color-surface-raised); border: 1px solid var(--color-border); border-radius: 12px;
  ...
  .hp-bar {
    width: 100%; background: var(--color-primary); border-radius: 5px 5px 0 0;
    opacity: 0.82; min-height: 4px;
  }
  .hp-bar-lbl { font-size: 10px; color: var(--color-text-muted); }
  .hp-research-card {
    background: var(--color-primary-light); border-radius: 10px; padding: 12px 14px;
  }
  .hp-rc-name { font-size: 13px; font-weight: 600; color: var(--color-text-primary); margin-bottom: 4px; }
  .hp-rc-ret { font-size: 12px; color: var(--color-primary); font-weight: 500; }
  ...
  .hp-score-val { font-size: 26px; font-weight: 700; color: var(--color-primary); }
  .hp-score-label { font-size: 14px; font-weight: 600; color: var(--color-text-secondary); margin-bottom: 20px; }
  .hp-checks { display: flex; flex-direction: column; gap: 8px; text-align: left; }
  .hp-check {
    display: flex; justify-content: space-between; align-items: center;
    background: var(--color-surface-raised); border-radius: 8px; padding: 8px 12px;
    font-size: 12px; color: var(--color-text-secondary);
  }
  .hp-check-ok  { color: var(--color-primary); font-weight: 600; }
  ...
  .hp-advisor-card {
    background: var(--color-surface-raised); border-radius: 20px; padding: 36px 32px;
  ...
  .hp-advisor-card.hp-mfd .hp-advisor-tag { background: var(--color-primary-light); color: var(--color-primary); }
  .hp-advisor-card.hp-ria .hp-advisor-tag { background: #e8f0fe; color: var(--color-advisor-ria); }
  .hp-advisor-headline {
    font-size: 1.35rem; font-weight: 700; line-height: 1.3;
    color: var(--color-text-primary); margin: 0 0 12px;
  }
  .hp-advisor-body {
    font-size: 15px; color: var(--color-text-secondary); line-height: 1.65; margin: 0 0 24px;
  }
  .hp-btn-mfd {
  ...
  .hp-btn-mfd:hover { background: var(--color-primary-dark); }
  .hp-btn-ria {
    padding: 11px 22px; background: var(--color-advisor-ria); color: #fff;
    border: none; border-radius: 8px; font-size: 14px; font-weight: 600;
    font-family: var(--font-body); cursor: pointer; transition: background 0.15s;
  }
  ...
  .hp-coming-headline {
    font-size: 1.8rem; font-weight: 700; color: var(--color-text-primary);
  ...
  .hp-footer-brand { font-size: 18px; font-weight: 700; color: var(--color-text-primary); letter-spacing: -0.01em; }
  .hp-footer-brand span { color: var(--color-primary); }
  ...
  .hp-footer-link:hover { color: var(--color-text-primary); }
  .hp-footer-disclaimer {
    font-size: 11px; color: var(--color-text-muted); line-height: 1.65;
    border-top: 1px solid var(--color-border); padding-top: 20px; margin: 0;
  }
  ...
  @media (prefers-color-scheme: dark) {
    .hp-btn-secondary:hover { background: rgba(29,158,117,0.15); }
  }
`
