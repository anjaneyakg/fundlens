...
const GROUPS = [
  {
    ...
    items: [
      ...
      { code:"A3", name:"SWP Performance",       tagline:"What did my withdrawals cost me?",      path:"/swp-performance",  live:false },
  ...
  },
  {
    id: "B", label: "Loans",
    items: [
      { code:"B1", name:"Loan EMI",              tagline:"What is my monthly payment?",           path:"/loan-emi",         live:false },
      { code:"B2", name:"Loan vs SIP",           tagline:"Should I prepay or invest?",            path:"/loan-vs-sip",      live:true  },
      { code:"B3", name:"Prepayment Benefit",    tagline:"What do I save by prepaying early?",    path:"/loan-prepayment",  live:false },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { code:"D2", name:"FD vs MF",              tagline:"Is FD better than debt fund?",          path:"/fd-vs-mf",         live:false },
